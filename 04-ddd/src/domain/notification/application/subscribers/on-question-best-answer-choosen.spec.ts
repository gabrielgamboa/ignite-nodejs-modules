...
import { CreateNotificationUseCase, CreateNotificationUseCaseRequest, CreateNotificationUseCaseResponse } from "../usecases/create-notification";
...
describe('On Question Best Answer Choosen Subscriber', () => {
  beforeEach(() => {
    ...
    createNotificationUseCase = new CreateNotificationUseCase(inMemoryNotificationsRepository);

    createNotificationExecuteSpy = vi.spyOn(createNotificationUseCase, 'execute')
    new OnQuestionBestAnswerChoosen(inMemoryAnswersRepository, createNotificationUseCase)
  })
